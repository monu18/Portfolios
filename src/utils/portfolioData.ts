...
const portfolioData = {
  ...
  phone: "(312) 358-2156",
  resume:
    "https://drive.google.com/file/d/1oY0cfRhuPDAmE9Dn501Yec_NjySms-OZ/view",

  profileIntro:
    "IA Financial Analyst by profession, I am passionate about helping businesses convert complex data into clear, strategic advantages. Holding a Master of Finance degree from the University of Illinois at Chicago (UIC) and having a solid background in accounting, I adeptly apply the Generally Accepted Accounting Principles (GAAP) in conjunction with contemporary analytical devices to facilitate better financial decision, making.\n\nMy skills range across a wide spectrum of financial analysis activities such as valuation, risk modeling, and enhancing reporting of P&L through NetSuite ERP and SQL. Besides merely spotting the causes of the variances in the past, I also help formulate the reporting structures which are essentially the growth roadmaps. One of the ways I have recently contributed is through creating DCF models which have been instrumental in investment decisions amounting to more than $2M, and significantly improving the efficiency of reporting cycles by cutting the manual part of it by 30%.\n\nWhat truly sets me apart from the rest is my ability to integrate technology into my analyses in order to achieve more profound results. Whether it is portfolio optimization or development of executive dashboards in Power BI, my focus remains on precision, efficiency, and providing valuable insights.\n\nMy target is a position that would allow me to work in Financial Analysis or FP&A where I can utilize my skills in financial modeling, forecasting, and process improvement to tackle complex challenges that lead to data, driven decisions.",
